...
const SLIDES = [
  {
    id: 0,
    title: 'The Minnus',
    subtitle: 'Embracing purity of form and structure for the contemporary wardrobe.',
  ...
  },
  {
    ...
    subtitle: 'Movement captured in exquisite textiles and effortless draping.',
    cta: 'View Skirts',
    ctaNav: 'Skirts',
        ...
        {SLIDES.map((slide, idx) => (
          ...
          >
            ...
            <div className={styles.slideContent}>
              <h2 className={`text-display-xl ${styles.slideTitle}`}>{slide.title}</h2>
              <p className={`text-body-lg ${styles.slideSubtitle}`}>{slide.subtitle}</p>
              <button
                id={`hero-cta-${idx}`}
